  ...
  return (
    <Flex flex={1} align={"center"} justify={"center"} flexDir="column">
      <Stack
        ...
        mb={{ base: "0", md: "4em" }}
      >
        <Stack padding={{ base: "5em 0", md: "2em", lg: "5em" }} align="center">
          <Heading
            textAlign="center"
            fontSize={{ base: "3xl", md: "4xl", lg: "5xl" }}
          >
            Add experienced talent to your organization’s key departments
          </Heading>
          <Tabs colorScheme="purple" w={"100%"}>
            ...
            <TabPanels>
              {TABS.map((tab) => (
                <TabPanel key={`${tab.id}_tab`} p={{ base: "0", md: "1em" }}>
                  <VStack spacing={3} alignItems="start" p={"1em"}>
